                        ...
                        <div className="grid gap-4 mb-4 sm:grid-cols-2">
                          <div>
                            ...
                            <input
                              ...
                              className="bg-violet-50 border border-violet-300 text-gray-900 text-sm rounded-lg focus:ring-violet-600 focus:border-violet-600 block w-full p-2.5 "
