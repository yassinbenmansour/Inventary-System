                      ...
                      <form action="#">
                        <div className="grid gap-4 mb-4 sm:grid-cols-2">
                          <div>
                            ...
                            <select
                              id="productID"
                              className="bg-violet-50 border border-violet-300 text-violet-600 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 "
                              name="productID"
                              onChange={(e) =>
...
Nom du magasin                            </label>
                          ...
                          <div>
                            <label
                              ...
                              className="block mb-2 text-sm font-medium text-gray-900 "
                            >
Montant total de la vente                            </label>
                            <input
                              type="number"
